...
- (void)transformToFitQuadTopLeft:(CGPoint)tl
                         ...
                         rotation:(CGFloat)rotation
{
    ...
    CATransform3D rotate = CATransform3DMakeTranslation(boundingBox.size.width/2, boundingBox.size.height/2, 0);
    rotate = CATransform3DRotate(rotate, rotation, 0, 0, 1);
    rotate = CATransform3DTranslate(rotate, -boundingBox.size.width/2, -boundingBox.size.height/2, 0);
//    CATransform3D rotate = CATransform3DMakeRotation(rotation, 0, 0, 1);
    transform = CATransform3DConcat(rotate, transform);
    
    transform = CATransform3DScale(transform, 2, 2, 1);
    self.layer.transform = CATransform3DTranslate(transform, -0.25 * boundingBox.size.width, -0.25 * boundingBox.size.height, 0);
